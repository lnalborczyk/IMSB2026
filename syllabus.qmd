...
Cette formation est composée de huit séances de trois heures (+ examen final) durant lesquelles seront dispensées connaissances théoriques et travaux pratiques en `R`, dans l'environnement `RStudio`.
