...
Pour cette formation, vous pourrez utiliser votre propre ordinateur sur lequel vous aurez [installé ou mis à jour](https://pbil.univ-lyon1.fr/CRAN/) `R` (version 4.5.2 recommandée) ainsi que l'interface utilisateur `RStudio` : <https://www.rstudio.com/products/rstudio/>. 
...
Au cours de la formation, ce paquet pourra être utilisé pour lire les slides des différents cours (du cours `01` au cours `09`) en ligne via la fonction `open_slides()`.
